export function PrivacyPolicyPage() {
  return (
    <div style={{ paddingLeft: '5rem', paddingRight: '5rem' }}>
      ...
      <p>
        Rye Labs LLC built the Rye Builder app as an Open Source app. This SERVICE is provided by
        Rye Labs LLC at no cost and is intended for use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        which are accessible at Rye Builder unless otherwise defined in this Privacy Policy.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        certain personally identifiable information, including but not limited to name, store name,
        products, purchase history, email address, ip address, user agent, cookies. The information
      ...
      <p>This policy is effective as of 2022-08-10</p>{' '}
      <p>
        <strong>Contact Us</strong>
      </p>{' '}
      <p>
        If you have any questions or suggestions about our Privacy Policy, do not hesitate to
        contact us at privacy@rye.com.
      </p>{' '}
      <p>
